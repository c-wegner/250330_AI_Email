# llama_server.py - Save this file and run it with Python
...
# CONFIGURATION - Updated with your exact path
LLAMA_CLI_PATH = "/home/cwegn/llama.cpp/build/bin/llama-cli"
MODEL_PATH = os.path.expanduser("~/fresh_gpu_setup/mistral-7b-instruct-v0.2.Q4_0.gguf")
    ...
    def run_llama_inference(self, prompt, max_tokens=4096, temperature=0.1, top_p=0.9):
        ...
        try:
            ...
            cmd = [
                ...
                '--n-threads', '8',       # Adjust based on your CPU
                ...
                '--gpu-vram', '22000'     # Set max VRAM usage (in MB) for RTX 5090
            ]
